...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future getSearch() async {
    ...
    if (searchInput.toString().isEmpty) {
      ...
      var uri =
          Uri.https('api.ndla.no', '/search-api/v1/search/', queryParameters);
  ...
  Widget build(BuildContext context) {
    ...
    double wp(double i) {
      return MediaQuery.of(context).size.width / 100 * i;
    }

    double hp(double i) {
      return MediaQuery.of(context).size.height / 100 * i;
    }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: Center(
              child: Padding(
                padding: EdgeInsets.only(
                    left: wp(10), right: wp(10), bottom: hp(2.5)),
                child: SvgPicture.asset('assets/logoWithText.svg',
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: AnimatedPadding(
                  ...
                  padding: EdgeInsets.only(
                      top: expandedOne ? hp(0) : hp(37.5),
                      left: expandedOne ? wp(0) : wp(5)),
              ...
              Align(
                ...
                child: AnimatedPadding(
                  ...
                  curve: Curves.fastOutSlowIn,
                  padding: EdgeInsets.only(
                      top: expandedThree ? hp(0) : hp(37.5),
                      right: expandedThree ? wp(0) : wp(5)),
                  child: GestureDetector(
                    onTap: () {
                      setState(() {
              ...
              GestureDetector(
                ...
                child: Align(
                  ...
                  child: AnimatedPadding(
                    ...
                    curve: Curves.fastOutSlowIn,
                    padding: EdgeInsets.only(
                        top: expandedBoxOne ? hp(0) : hp(59),
                        left: expandedBoxOne ? wp(0) : wp(2.5)),
                    child: AnimatedContainer(
                      duration: Duration(milliseconds: 350),
                      curve: Curves.fastOutSlowIn,
              ...
              GestureDetector(
                ...
                child: Align(
                  ...
                  child: AnimatedPadding(
                    ...
                    curve: Curves.fastOutSlowIn,
                    padding: EdgeInsets.only(
                        top: expandedBoxTwo ? hp(0) : hp(59),
                        right: expandedBoxTwo ? wp(0) : wp(2.5)),
                    child: AnimatedContainer(
                      duration: Duration(milliseconds: 350),
                      curve: Curves.fastOutSlowIn,
              ...
              GestureDetector(
                ...
                child: Align(
                  ...
                  child: AnimatedPadding(
                    ...
                    curve: Curves.fastOutSlowIn,
                    padding: EdgeInsets.only(
                        top: expandedBoxThree ? hp(0) : hp(81),
                        left: expandedBoxThree ? wp(0) : wp(2.5)),
                    child: AnimatedContainer(
                      duration: const Duration(milliseconds: 350),
                      curve: Curves.fastOutSlowIn,
              ...
              GestureDetector(
                ...
                child: Align(
                  ...
                  child: AnimatedPadding(
                    ...
                    curve: Curves.fastOutSlowIn,
                    padding: EdgeInsets.only(
                        top: expandedBoxFour ? hp(0) : hp(81),
                        right: expandedBoxFour ? wp(0) : wp(2.5)),
                    child: AnimatedContainer(
                      duration: Duration(milliseconds: 350),
                      curve: Curves.fastOutSlowIn,
          ...
          Stack(
            children: <Widget>[
              AnimatedPadding(
                ...
                curve: Curves.fastOutSlowIn,
                padding: EdgeInsets.only(
                    top: isSearching ? hp(0) : hp(25),
                    left: isSearching ? wp(0) : wp(5)),
                child: AnimatedContainer(
                  duration: Duration(milliseconds: 500),
                  curve: Curves.fastOutSlowIn,
                  ...
                  child: AnimatedAlign(
                    alignment:
                        isSearching ? Alignment.topCenter : Alignment.center,
                    duration: Duration(milliseconds: 500),
                    curve: Curves.fastOutSlowIn,
                    child: AnimatedPadding(
                      ...
                      child: AnimatedPadding(
                        ...
                        curve: Curves.fastOutSlowIn,
                        padding: EdgeInsets.only(
                            left: isSearchingAnim ? wp(5) : wp(0)),
                        child: TextField(
                          onChanged: (input) {
                            searchInput = input;
                            setState(() {});
                          ...
                          decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                                    color: Pigment.fromString("a5bcd3"))),
                            filled: true,
                            fillColor: Colors.white,
                            hintText: "Hva vil du lære om i dag?",
                            contentPadding:
                                EdgeInsets.only(left: wp(2.5), top: 0),
              ...
              AnimatedPadding(
                ...
                curve: Curves.fastOutSlowIn,
                padding: EdgeInsets.only(
                    left: isSearchingAnim ? wp(5.5) : wp(8),
                    top: isSearchingAnim ? hp(8) : hp(10)),
                child: GestureDetector(
              ...
              AnimatedPadding(
                ...
                curve: Curves.fastOutSlowIn,
                padding:
                    EdgeInsets.only(top: isSearchingAnim ? hp(19) : hp(23)),
                child: Align(
                  alignment: Alignment.topCenter,
                  child: AnimatedContainer(
                    duration: Duration(milliseconds: 500),
                    ...
                    child: Padding(
                      padding: EdgeInsets.only(
                          left: wp(2.5), right: wp(2.5), top: hp(2)),
                      ...
                      child:
                        ...
                        child: ListView(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              padding: EdgeInsets.only(right: wp(2.5)),
                              child: const Text("Oppgaver og aktiviteter",
                                  style: TextStyle(
                                      color: Colors.black54,
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold)),
                            ...
                            Padding(
                              padding: EdgeInsets.only(right: wp(2.5)),
                              child: const Text("Vurderingsressurs",
                                  style: TextStyle(
                                      color: Colors.black54,
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold)),
                            ...
                            Padding(
                              padding: EdgeInsets.only(right: wp(2.5)),
                              child: const Text("Kildemateriale",
                                  style: TextStyle(
                                      color: Colors.black54,
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold)),
                            ...
                            Padding(
                              padding: EdgeInsets.only(right: wp(2.5)),
                              child: const Text("Ekstern læringsressurs",
                                  style: TextStyle(
                                      color: Colors.black54,
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold)),
              ...
              child: GestureDetector(
                ...
                child: AnimatedPadding(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: Pigment.fromString("deebf6"),
                      borderRadius: BorderRadius.circular(expandedOne
                          ? hp(0)
                          : expandedTwo
                              ? hp(0)
                              : expandedThree
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedPadding(
                      ...
                      child: AnimatedContainer(
                        duration: const Duration(milliseconds: 350),
                        curve: Curves.fastOutSlowIn,
                        width: expandedBoxOne
                            ? wp(100)
                            : expandedBoxTwo
                                ? wp(100)
                                : wp(46.25),
                        height: expandedBoxOne
                            ? hp(100)
                            : expandedBoxTwo
                                ? hp(100)
                                : hp(15),
          ...
          Padding(
            padding: EdgeInsets.only(
                top: expandedBoxThree
                    ? hp(0)
                    : expandedBoxFour
                        ? hp(0)
                        : hp(100)),
            child: Align(
              alignment: expandedBoxThree
                  ? Alignment.topLeft
                  : expandedBoxFour
                      ? Alignment.topRight
                      : Alignment.topLeft,
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedPadding(
                      ...
                      padding: EdgeInsets.only(
                          top: expandedBoxThree
                              ...
                              : expandedBoxFour
                                  ? hp(0)
                                  : hp(81),
                          left: expandedBoxThree
                              ? wp(0)
                              : expandedBoxFour
                                  ? wp(0)
                                  : wp(2.5),
                          right: expandedBoxThree
                              ? wp(0)
                              : expandedBoxFour
                                  ? wp(0)
                                  : wp(2.5)),
                      child: AnimatedContainer(
                        duration: Duration(milliseconds: 350),
                        curve: Curves.fastOutSlowIn,
                        width: expandedBoxThree
                            ? wp(100)
                            : expandedBoxFour
                                ? wp(100)
                                : wp(46.25),
                        height: expandedBoxThree
                            ? hp(100)
                            : expandedBoxFour
                                ? hp(100)
                                : hp(15),
...
class _ArticlePageState extends State<ArticlePage> {
  ...
  Future getArticle() async {
    ...
    var uri = Uri.https('api.ndla.no',
        '/article-api/v2/articles/$chosenArticle', queryParameters);
    var response = await http.get(uri, headers: {
      // HttpHeaders.authorizationHeader: 'Token $token',
      HttpHeaders.contentTypeHeader: 'application/json',
    });
  ...
  Future getArticleImage() async {
    ...
    var uri = Uri.https(
        'api.ndla.no', '/image-api/v2/images/$articleImage', queryParameters);
    var response = await http.get(uri, headers: {
      // HttpHeaders.authorizationHeader: 'Token $token',
      HttpHeaders.contentTypeHeader: 'application/json',
    });
          ...
          FutureBuilder(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasData) {
                ...
                final text = data['visualElement'] == null
                    ? ""
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        data['copyright']['creators'][0]['name'],
                        style: TextStyle(fontSize: 25),
                      ),
                    ),
                        ...
                        : FutureBuilder(
                            ...
                            builder: (context, snapshot) {
                              return Image.network(
                                data['imageUrl'],
                                semanticLabel: data['alttext']['alttext'],
                                fit: BoxFit.contain,
                              );
                            }),
                    // Content
